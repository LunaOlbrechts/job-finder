                ...
                <div class="card-body">
                    ...
                    @endisset
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" id="companyNameDiv">
                                <input id="companyName" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6" id="companyNameDivAuto">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Telefoon nummber') }}</label>
