...
<div class="container-applications">
    <div class="sitenav--applications">  
        <ul>
            <a href="#"><li>Huidige fase</li></a>
            <a href="#"><li>Historiek fase</li></a>
            <a href="#"> <li>Solicitanten</li></a>
            <a href="#"><li></li></a>
        </ul>  
    </div>
    <div class=""> 
        <h1 class="page--title">Overzichat solicitaties</h1>
        <div class="col-md-12">
            <div class="card">
